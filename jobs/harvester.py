...
SEED=[
 FeedItem(scam_type='Cloned voice',title='Family emergency transfer calls reported',summary='Reports describe cloned family voices demanding an urgent transfer.',region='Ipoh',lat=4.5975,lng=101.0901,source_name='DJAGA community intelligence',source_url='https://www.rmp.gov.my',date='2026-07-16'),
 FeedItem(scam_type='Macau',title='Fake officer calls target residents',summary='Callers claim accounts are under investigation and demand immediate action.',region='Kuala Lumpur',lat=3.139,lng=101.6869,source_name='DJAGA community intelligence',source_url='https://www.rmp.gov.my',date='2026-07-16'),
 FeedItem(scam_type='Investment',title='WhatsApp investment promise alert',summary='High-return investment messages are circulating in local groups.',region='Manjung',lat=4.210,lng=100.650,source_name='DJAGA community intelligence',source_url='https://www.nacsa.gov.my',date='2026-07-15'),
 FeedItem(scam_type='Romance',title='Romance scam payment requests',summary='Victims report rapid relationship escalation followed by financial requests.',region='Penang',lat=5.4164,lng=100.3327,source_name='DJAGA community intelligence',source_url='https://www.mycert.org.my',date='2026-07-15'),
 FeedItem(scam_type='Phishing',title='Bank verification links circulating',summary='Messages imitate bank notices and lead to credential-harvesting pages.',region='Alor Setar',lat=6.1248,lng=100.3678,source_name='DJAGA community intelligence',source_url='https://www.mycert.org.my',date='2026-07-14'),
]
