...
_agents={"intake":IntakeAgent(),"forensics":ForensicsAgent(),"image_forensics":ImageForensicsAgent(),"transcribe":TranscribeAgent(),"behavioral":BehavioralAgent(),"registry":RegistryAgent(),"osint":OSINTAgent()}
